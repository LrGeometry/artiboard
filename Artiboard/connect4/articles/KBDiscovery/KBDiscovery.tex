...
% TODO: This section mus be rewritten
% definition 
Many artificial intelligence problems can be viewed as classification problems \cite{wagacha:trees}. The ability to classify can be described as the ability to predict a particular attribute value of an entity based on the values of the other attributes of that entity.  

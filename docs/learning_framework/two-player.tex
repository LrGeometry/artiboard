...
% introduce negamax
Instead of alternating the minimum and maximum operation, the minimax value of the minimising can be negated. These values are called \myterm{negamax values} \cite{furnkranz:survey} and they turn minimax into a slightly simpler algorithm. See \refalg{alg:negamax} for an utline of this idea.

...
\section{TODO Experiment: The effect of test example selection} %c4-025
...
For each test selection strategy an observation is made $100$ times.  For each observation a random selection of $\ceil{1/2}$ of $\myset U$ is used to measure the \myterm{Decision Accuracy} of $T_t$.  The random selection holds to the invariants implied by each selection strategy. 
